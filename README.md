...
- The app has been updated with front end authentication and authorization
- Now users can edit their profile after authorization
- The backend and the front end are now connected. The frond end gets live data from the server.
